      ...
      <div className="bg-white border-b border-n26-secondary/30 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold text-n26-primary`}>Dashboard</h1>
          </div>
            ...
            {!isMobile && (
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Suchen..."
                  className="pl-10 w-64 bg-n26-light border-n26-secondary/30 focus:bg-white focus:border-n26-primary cursor-pointer"
