...
type DbAssetUpdate = Database['public']['Tables']['assets']['Update'];

export const mapAssetToDbAssetUpdate = (asset: Asset): DbAssetUpdate => {
  console.log("=== mapAssetToDbAssetUpdate Debug ===");
  console.log("Input asset for update:", asset);
  
  const updateData: DbAssetUpdate = {
    name: asset.name,
    type: asset.type,
